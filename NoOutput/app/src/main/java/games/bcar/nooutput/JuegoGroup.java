...
public class JuegoGroup extends ViewGroup {
    private static final String TAG = "CustomLayout";
    private LinearLayout cll ;
    public JuegoGroup(Context context){
        super(context);
        init();
    }
    public JuegoGroup(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }
    public JuegoGroup(Context context, AttributeSet attrs, int defStyle){
